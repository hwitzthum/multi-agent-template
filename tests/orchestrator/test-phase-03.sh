...
[ "$(wc -l < "$fixture/docs/state/metrics.csv" | tr -d ' ')" = 2 ] && grep -q ',verified,PATTERNED_LOCAL,false,1,' "$fixture/docs/state/metrics.csv" && ok || bad "Metrik enthaelt Modus, Grund und Regelversion"
